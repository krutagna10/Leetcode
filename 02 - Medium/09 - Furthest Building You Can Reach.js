...
class Heap {
    ...
    heapifyDown() {
        ...
        while(this.values[this.getLeftChildIndex(currentIndex)] !== undefined) {
            ...
            if (this.values[this.getRightChildIndex(currentIndex)] !== undefined && this.values[this.getRightChildIndex(currentIndex)] > this.values[this.getLeftChildIndex(currentIndex)] ) {
